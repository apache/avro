...
/** Ant task to generate Java interface and classes for a schema. */
public class SchemaTask extends ProtocolTask {
  @Override
  protected void doCompile(File src, File dest) throws IOException {
    final SchemaParser parser = new SchemaParser();
    SchemaParser.ParseResult parseResult = parser.parse(src);
    for (Schema schema : parseResult.parsedNamedSchemas()) {
