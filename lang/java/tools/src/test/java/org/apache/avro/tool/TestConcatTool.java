...
public class TestConcatTool {
  ...
  // the best way to test is to write to HDFS and compare append output to the
  // fresh output file generated by the plain concat operation writing to HDFS
  public void testAppend() throws Exception {
    ...
    assertEquals(ROWS_IN_INPUT_FILES * 3, numRowsInFile(input1));
    assertEquals(ROWS_IN_INPUT_FILES, numRowsInFile(input2));
    assertEquals(ROWS_IN_INPUT_FILES, numRowsInFile(input3));
  }
