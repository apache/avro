...
public class MinBytesPerElementTest {
  ...
  public void setup() throws IOException {
    ...
    arrayWrapperSchema
        .setFields(Arrays.asList(new Schema.Field("items", Schema.createArray(elementSchema), null, null)));

    mapWrapperSchema = Schema.createRecord("MapWrapper", null, "test", false);
    mapWrapperSchema.setFields(Arrays.asList(new Schema.Field("entries", Schema.createMap(elementSchema), null, null)));
  ...
  private static Schema buildWideSchema() {
    ...
    innerRecord.setFields(Arrays.asList(new Schema.Field("x", Schema.create(Schema.Type.INT), null, null),
  ...
  private static Schema buildDeepSchema() {
    ...
    current.setFields(Arrays.asList(new Schema.Field("value", Schema.create(Schema.Type.INT), null, null)));

    for (int i = 9; i >= 1; i--) {
      Schema next = Schema.createRecord("Level" + i, null, "test", false);
      next.setFields(Arrays.asList(new Schema.Field("value", Schema.create(Schema.Type.INT), null, null),
  ...
  private static Schema buildRecursiveSchema() {
    ...
    Schema union = Schema.createUnion(Arrays.asList(nullSchema, recursive));
    recursive.setFields(Arrays.asList(new Schema.Field("value", Schema.create(Schema.Type.INT), null, null),
