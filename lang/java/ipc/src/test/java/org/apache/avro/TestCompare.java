...
public class TestCompare {
  ...
  void testNull() throws Exception {
    Schema schema = new SchemaParser().parse("\"null\"");
  ...
  void record() throws Exception {
    ...
    Schema schema2 = new SchemaParser().parse(record2Json);
  ...
  private static <T> void check(String schemaJson, T o1, T o2, boolean comparable) throws Exception {
    check(new SchemaParser().parse(schemaJson), o1, o2, comparable, new GenericDatumWriter<>(), GenericData.get());
  }
