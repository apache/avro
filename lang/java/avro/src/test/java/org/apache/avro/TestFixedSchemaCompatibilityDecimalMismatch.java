...
import static org.apache.avro.TestSchemas.FIXED_DECIMAL_3_2;
import static org.apache.avro.TestSchemas.FIXED_DECIMAL_3_3;
import static org.apache.avro.TestSchemas.FIXED_DECIMAL_4_3;

@RunWith(Parameterized.class)
public class TestFixedSchemaCompatibilityDecimalMismatch {

  @Parameters(name = "r: {0} | w: {1}")
  public static Iterable<Object[]> data() {
    Object[][] fields = {
        { FIXED_DECIMAL_3_3 , FIXED_DECIMAL_3_2,
                "Decimal (precision,scale) doesn't match for reader (3,3) and writer (3,2) schemas", "/scaleOrPrecision"},
        { FIXED_DECIMAL_3_3 , FIXED_DECIMAL_4_3,
