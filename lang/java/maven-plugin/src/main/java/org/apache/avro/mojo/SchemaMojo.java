...
import org.apache.avro.logical.AbstractLogicalTypeContainer;
  ...
  private void registerContainers() {
    try {
      for (String logicalTypeContainer : logicalTypeContainers) {
        AbstractLogicalTypeContainer container = (AbstractLogicalTypeContainer) Class.forName(logicalTypeContainer).newInstance();
