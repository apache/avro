...
public class Test
  ...
  private static final org.apache.thrift.protocol.TField STRING_OPTIONAL_FIELD_WITH_DEFAULT_FIELD_DESC = new org.apache.thrift.protocol.TField(
      "stringOptionalFieldWithDefault", org.apache.thrift.protocol.TType.STRING, (short) 17);
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String stringOptionalFieldWithDefault; // optional
  ...
  private static final _Fields optionals[] = { _Fields.BYTE_OPTIONAL_FIELD, _Fields.I16_OPTIONAL_FIELD,
      _Fields.I32_FIELD, _Fields.STRING_OPTIONAL_FIELD_WITH_DEFAULT, _Fields.BINARY_FIELD };
  ...
  static {
    ...
    tmpMap.put(_Fields.STRING_OPTIONAL_FIELD_WITH_DEFAULT,
        new org.apache.thrift.meta_data.FieldMetaData("stringOptionalFieldWithDefault",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getStringOptionalFieldWithDefault() {
    return this.stringOptionalFieldWithDefault;
  }

  public void setStringOptionalFieldWithDefault(
      @org.apache.thrift.annotation.Nullable java.lang.String stringOptionalFieldWithDefault) {
  ...
  /**
   * Returns true if field stringOptionalFieldWithDefault is set (has been
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case STRING_OPTIONAL_FIELD_WITH_DEFAULT:
      if (value == null) {
        ...
        setStringOptionalFieldWithDefault((java.lang.String) value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetStringOptionalFieldWithDefault()) ? 131071 : 524287);
    if (isSetStringOptionalFieldWithDefault())
      hashCode = hashCode * 8191 + stringOptionalFieldWithDefault.hashCode();
  ...
  public int compareTo(Test other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetByteOptionalField()).compareTo(other.isSetByteOptionalField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetByteOptionalField()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetI16OptionalField()).compareTo(other.isSetI16OptionalField());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetI16OptionalField()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStringOptionalFieldWithDefault())
        .compareTo(other.isSetStringOptionalFieldWithDefault());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStringOptionalFieldWithDefault()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.stringOptionalFieldWithDefault,
          other.stringOptionalFieldWithDefault);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFooOrBar()).compareTo(other.isSetFooOrBar());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFooOrBar()) {
  ...
  private static class TestStandardScheme extends org.apache.thrift.scheme.StandardScheme<Test> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Test struct) throws org.apache.thrift.TException {
      ...
      while (true) {
        ...
        case 17: // STRING_OPTIONAL_FIELD_WITH_DEFAULT
          if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
            struct.stringOptionalFieldWithDefault = iprot.readString();
            struct.setStringOptionalFieldWithDefaultIsSet(true);
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
          }
          break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Test struct) throws org.apache.thrift.TException {
      ...
      if (struct.stringOptionalFieldWithDefault != null) {
        if (struct.isSetStringOptionalFieldWithDefault()) {
          oprot.writeFieldBegin(STRING_OPTIONAL_FIELD_WITH_DEFAULT_FIELD_DESC);
          oprot.writeString(struct.stringOptionalFieldWithDefault);
          oprot.writeFieldEnd();
        }
      }
