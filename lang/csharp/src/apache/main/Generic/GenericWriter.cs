...
namespace Avro.Generic
{
    ...
    public class DefaultWriter
    {
        ...
        /// <param name="value">The value to be serialized</param>
        /// <param name="encoder">The encoder for serialization</param>
        protected virtual void WriteLogical(LogicalSchema logicalSchema, object value, Encoder encoder) => Write(logicalSchema.BaseSchema, logicalSchema.LogicalType.ConvertToBaseValue(value, logicalSchema), encoder);
