...
namespace Avro.perf
{
    class Program
    {
        ...
        private static void PerfTest<T>(string name, string impl, T z, Schema schema, Func<Schema,DatumWriter<T>> writerFactory, Func<Schema,IDatumReader<T>> readerFactory)
        {
            var stream = new MemoryStream();
