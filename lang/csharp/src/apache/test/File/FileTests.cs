...
namespace Avro.Test.File
{
    ...
    {
        private const string specificSchema = "{\"type\":\"record\",\"name\":\"Foo\",\"namespace\":\"Avro.Test.File\",\"fields\":"
        ...
        private class ReaderWriterSet<T>
        {
    ...
    internal class FakeZstdCodec : Codec
    {
