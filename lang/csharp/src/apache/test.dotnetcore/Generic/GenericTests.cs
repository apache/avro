...
namespace Avro.Test.Generic
{
    class GenericTests
    {
        ...
        public void TestUnion_enum(string unionSchema, string enumSchema, string value, Type exceptionType = null)
        {
            if (exceptionType == null)
                test(unionSchema, mkEnum(enumSchema, value));
            else
                Assert.Throws(exceptionType, () => test(unionSchema, mkEnum(enumSchema, value)));
        }
        ...
        [TestCase("[{\"type\": \"fixed\", \"size\": 2, \"name\": \"f\"}, \"string\"]",
            ...
            typeof(AvroException))]
        public void TestUnion_fixed(string unionSchema, string fixedSchema, byte[] value, Type exceptionType = null)
        {
            if (exceptionType == null)
                test(unionSchema, mkFixed(fixedSchema, value));
            else
                Assert.Throws(exceptionType, () => test(unionSchema, mkFixed(fixedSchema, value)));
        }
        ...
        [TestCase("int", 10, "{\"type\":\"record\",\"name\":\"r\",\"fields\":[{\"name\":\"f\", \"type\":\"int\"}]}", typeof(AvroException))]
        ...
        [TestCase("{\"type\":\"array\",\"items\":\"int\"}", new int[] { 10 }, "\"boolean\"", typeof(AvroException))]
        [TestCase("{\"type\":\"array\",\"items\":\"int\"}", new int[] { 10 }, "{\"type\":\"array\",\"items\":\"string\"}", typeof(AvroException))]
        [TestCase("[\"int\", \"boolean\"]", 10, "[\"string\", \"bytes\"]", typeof(AvroException))]
        [TestCase("[\"int\", \"boolean\"]", 10, "\"string\"", typeof(AvroException))]
        public void TestResolutionMismatch_simple(string writerSchema, object value, string readerSchema, Type exceptionType)
        {
            Assert.Throws(exceptionType, () => testResolutionMismatch(writerSchema, value, readerSchema));
        }
        ...
        public void TestResolutionMismatch_record(string ws, object[] actual, string rs, Type exceptionType)
        {
            Assert.Throws(exceptionType, () => testResolutionMismatch(ws, mkRecord(actual, Schema.Parse(ws) as RecordSchema), rs));
        }
        ...
        public void TestResolutionMismatch_enum(string ws, string value, string rs, Type exceptionType)
        {
            Assert.Throws(exceptionType, () => testResolutionMismatch(ws, mkEnum(ws, value), rs));
        }
        ...
        [TestCase("{\"type\":\"map\",\"values\":\"int\"}",
            ...
            typeof(AvroException), Description = "Name mismatch")]
        public void TestResolutionMismatch_map(string ws, object[] value, string rs, Type exceptionType)
        {
            Assert.Throws(exceptionType, () => testResolutionMismatch(ws, mkMap(value), rs));
        }
        ...
        public void TestResolutionMismatch_fixed(string ws, byte[] value, string rs, Type exceptionType)
        {
            Assert.Throws(exceptionType, () => testResolutionMismatch(ws, mkFixed(ws, value), rs));
        }
