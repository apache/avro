...
class ExampleProtocol(object):
    def __init__(self, protocol_dict, valid, name='', comment=''):
        self._protocol_string = json.dumps(protocol_dict)
        self._valid = valid
        self._name = name or self._protocol_string  # default to schema_string for name
...
TEST_NAMESPACE = ExampleProtocol({
...
TEST_IMPLICIT_NAMESPACE = ExampleProtocol({
    "namespace": "org.apache.avro.test.namespace",
...
TEST_NAMESPACE_TWO = ExampleProtocol({
    "namespace": "org.apache.avro.test.namespace",
...
TEST_VALID_REPEATED_NAME = ExampleProtocol({
    "namespace": "org.apache.avro.test.namespace",
...
TEST_INVALID_REPEATED_NAME = ExampleProtocol({
    "namespace": "org.apache.avro.test.namespace",
...
TEST_BULK_DATA = ExampleProtocol({
    "namespace": "org.apache.avro.test",
    "protocol": "BulkData",
    "types": [],
    "messages": {
...
EXAMPLES = [HELLO_WORLD,
            ...
            TEST_NAMESPACE_TWO,
            TEST_VALID_REPEATED_NAME,
            TEST_INVALID_REPEATED_NAME,
            TEST_BULK_DATA,
            TEST_API]
