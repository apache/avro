...
FINGERPRINT_EXAMPLES = [
        ...
        (json.dumps({
            ...
            '43818703b7b5d769',
            '16ded8b5027e80a17704c6565c0c3f1b',
...
class TestMisc(unittest.TestCase):
    ...
    def test_parse_invalid_symbol(self):
        ...
        try:
            ...
            self.fail(
                "When enum symbol validation is enabled, "
